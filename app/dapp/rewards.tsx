  ...
  return (
    <div className="container max-h-screen overflow-y-auto lg:max-h-none lg:overflow-visible pb-24 lg:pb-0">
      ...
      <div className="flex flex-col gap-10 md:gap-14 lg:flex-row lg:gap-20">
        {/* Card 1 */}
        <div className="flex flex-col gap-3 md:gap-4 lg:gap-6 justify-center items-center w-[280px] md:w-[480px] lg:w-[630px] py-3 md:py-6 lg:py-0 lg:min-h-[410px] mx-auto border-2 border-[#FFFFFF0F] rounded-[20px] bg-[#18181780] backdrop-blur-2xl">
          <div className="w-[250px] md:w-[380px] lg:w-[460px] flex flex-col gap-6 justify-center items-center">
